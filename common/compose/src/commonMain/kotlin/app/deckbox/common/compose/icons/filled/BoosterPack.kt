...
val Icons.Filled.BoosterPack: ImageVector
  get() {
    if (_boosterPack != null) {
      return _boosterPack!!
    }
    _boosterPack = ImageVector.Builder(
      name = "Filled.BoosterPack",
      defaultWidth = 24.dp,
      defaultHeight = 24.dp,
      viewportWidth = 24f,
      viewportHeight = 24f
      ...
      path(
        ...
        lineTo(19f, 8f)
        lineTo(19f, 5.5f)
        curveTo(19f, 5.5f, 18.8732f, 4.5f, 18f, 4.5f)
        curveTo(17.1268f, 4.5f, 16.8732f, 5.5f, 16f, 5.5f)
        curveTo(15.1268f, 5.5f, 14.8732f, 4.5f, 14f, 4.5f)
        curveTo(13.1268f, 4.5f, 12.8732f, 5.5f, 12f, 5.5f)
        curveTo(11.1268f, 5.5f, 10.8732f, 4.5f, 10f, 4.5f)
        curveTo(9.1268f, 4.5f, 8.8732f, 5.5f, 8f, 5.5f)
        curveTo(7.1268f, 5.5f, 6.8732f, 4.5f, 6f, 4.5f)
        close()
      }
      path(
        fill = SolidColor(Color(0xFF000000)),
        ...
        moveTo(5f, 10f)
        lineTo(4.99999f, 19f)
        curveTo(5f, 19.5523f, 5.4477f, 20f, 6f, 20f)
        horizontalLineTo(18f)
        curveTo(18.5523f, 20f, 19f, 19.5523f, 19f, 19f)
        lineTo(19f, 10f)
        horizontalLineTo(5f)
        close()
      }
