...
class DeckBoxSettingsImpl(
  ...
  override var browseCardGridStyle: PokemonGridStyle by enumSetting(KEY_BROWSE_GRID_STYLE, PokemonGridStyle)
  override fun observeBrowseCardGridStyle(): Flow<PokemonGridStyle> {
    return flowSettings.getEnumFlow(KEY_BROWSE_GRID_STYLE, PokemonGridStyle)
  }

  override var expansionCardGridStyle: PokemonGridStyle by enumSetting(KEY_EXPANSION_GRID_STYLE, PokemonGridStyle)
  override fun observeExpansionCardGridStyle(): Flow<PokemonGridStyle> {
    return flowSettings.getEnumFlow(KEY_EXPANSION_GRID_STYLE, PokemonGridStyle)
  }
