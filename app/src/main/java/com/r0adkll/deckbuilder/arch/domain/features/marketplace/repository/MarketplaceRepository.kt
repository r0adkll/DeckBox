...
interface MarketplaceRepository {
     ...
     * @return an observable of the list of prices for all of the [cardIds], if their price could be found
     */
    fun getPrices(cardIds: List<String>): Observable<List<Price>>
}
